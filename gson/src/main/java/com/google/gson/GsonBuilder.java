...
public final class GsonBuilder {
    ...
    private final Map<Type, InstanceCreator<?>> instanceCreators = new org.apache.commons.collections4.map.HashedMap<Type, InstanceCreator<?>>();

    private final List<TypeAdapterFactory> factories = new org.eclipse.collections.impl.list.mutable.FastList<TypeAdapterFactory>();

    /**
     * tree-style hierarchy factories. These come after factories for backwards compatibility.
     */
    private final List<TypeAdapterFactory> hierarchyFactories = new org.eclipse.collections.impl.list.mutable.FastList<TypeAdapterFactory>();
