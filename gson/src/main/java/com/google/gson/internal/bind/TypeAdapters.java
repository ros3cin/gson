...
public final class TypeAdapters {
    ...
    private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        private final Map<String, T> nameToConstant = new org.apache.commons.collections4.map.HashedMap<String, T>();

        private final Map<T, String> constantToName = new org.apache.commons.collections4.map.HashedMap<T, String>();
