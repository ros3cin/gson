...
public final class TypeAdapters {
    ...
    private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
        ...
        private final Map<String, T> nameToConstant = new java.util.LinkedHashMap<String, T>();

        private final Map<T, String> constantToName = new java.util.LinkedHashMap<T, String>();
